...
do
	local ok = false
	pcall(function()
		if _G.HSX_ALLOW_WINDUI == true then ok = true end
		if getgenv and getgenv().HSX_ALLOW_WINDUI == true then ok = true end
...
local b=(function(b)return b end)
...
local j="https://raw.githubusercontent.com/hollymrak/HSXLibrary/refs/heads/main/Icons.lua"
...
local ae=(function(ae)return ae end)
